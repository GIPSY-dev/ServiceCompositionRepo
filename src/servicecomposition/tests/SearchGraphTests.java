...
public class SearchGraphTests 
{
	...
	public void addOneService()
	{
		...
		Service service = new ConstrainedService(new BasicService("sname1", inputs, outputs), constraints, effects);
	...
	public void addSvcsToExistingLayer()
	{
		...
		Service service4 = new ConstrainedService(new BasicService("sname4", inputs4, outputs4), constraints4, effects4);
		...
		Service service5 = new ConstrainedService(new BasicService("sname5", inputs5, outputs5), constraints5, effects5);
	...
	private SearchGraph getSingleLayerGraph()
	{
		...
		Service service1 = new ConstrainedService(new BasicService("sname1", inputs1, outputs1), constraints1, effects1);
		...
		Service service2 = new ConstrainedService(new BasicService("sname2", inputs2, outputs2), constraints2, effects2);
		...
		Service service3 = new ConstrainedService(new BasicService("sname3", inputs3, outputs3), constraints3, effects3);
	...
	private SearchGraph getMultiLayerGraph()
	{
		...
		Service service6 = new ConstrainedService(new BasicService("sname6", inputs6, outputs6), constraints6, effects6);
		...
		Service service7 = new ConstrainedService(new BasicService("sname7", inputs7, outputs7), constraints7, effects7);
